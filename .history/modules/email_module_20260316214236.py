...
class EmailService:
    ...
    VALID_TEMPLATES = {
          "aprovacao_candidatura",
          "proximos_passos",
          "reprovacao_candidatura",
    }
...
def _get_subject(template_name: str, nome: str) -> str:
    subjects = {
        "aprovacao_candidatura": f"Sua candidatura foi aprovada, {nome}! 🎉",
        "proximos_passos":       f"Próximos passos do seu processo seletivo, {nome}",
        "reprovacao_candidatura": f"Atualização sobre sua candidatura, {nome}",
    }
    return subjects.get(
        template_name,
        f"Atualização do processo seletivo - {nome}"
